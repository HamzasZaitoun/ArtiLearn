        ...
        <form action="{{ route('admin.testimonials.update', $testimonial) }}" method="POST" class="p-6">
            ...
            <div class="mb-6 border-b pb-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="author_en"
                        value="{{ old('author_en', $testimonial->author_name['en'] ?? '') }}"
            ...
            <div class="mb-6 border-b pb-6" dir="rtl">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="author_ar"
                        value="{{ old('author_ar', $testimonial->author_name['ar'] ?? '') }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        required>
                </div>
                <div class="mb-4">
                    ...
                    <textarea name="content_ar" rows="3"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        required>{{ old('content_ar', $testimonial->content['ar'] ?? '') }}</textarea>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <select name="rating"
                            ...
                            @foreach([5, 4, 3, 2, 1] as $r)
                                <option value="{{ $r }}" {{ $testimonial->rating == $r ? 'selected' : '' }}>{{ $r }} Stars
                                </option>
                            @endforeach
                        </select>
                    </div>
